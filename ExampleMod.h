...
public:
	...
	ExampleMod()
	{
		ModName = "ISZ-ModMenuLoader"; // Mod Name -- If Using BP ModActor, Should Be The Same Name As Your Pak
		ModVersion = "1.0.0"; // Mod Version
		ModDescription = "Loads ISZ-ModMenu Using UML or UMU."; // Mod Description
		ModAuthors = "Cracko298"; // Mod Author
